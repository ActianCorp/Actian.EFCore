...
/// <summary>
///     An expression that represents an OPENJSON function call in a SQL tree.
/// </summary>
/// <remarks>
///     <para>
...
///     </para>
/// </remarks>
public class ActianOpenJsonExpression : TableValuedFunctionExpression
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public ActianOpenJsonExpression(
        string alias,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual ActianOpenJsonExpression Update(
        SqlExpression jsonExpression,
        ...
        IReadOnlyList<ColumnInfo>? columnInfos = null)
    {
        ...
        return jsonExpression == JsonExpression
            ...
            && (ReferenceEquals(columnInfos, ColumnInfos)
                ...
                ? this
                : new ActianOpenJsonExpression(Alias, jsonExpression, path, columnInfos);
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual ActianOpenJsonExpression Update(SqlExpression sqlExpression)
    ...
    public override TableExpressionBase Clone(string? alias, ExpressionVisitor cloningExpressionVisitor)
    {
        ...
        var clone = new ActianOpenJsonExpression(alias!, newJsonExpression, Path, ColumnInfos);
    ...
    /// <inheritdoc />
    public override ActianOpenJsonExpression WithAlias(string newAlias)
        => new(newAlias, JsonExpression, Path, ColumnInfos);

    /// <inheritdoc />
    public override Expression Quote()
        => New(
            _quotingConstructor ??= typeof(ActianOpenJsonExpression).GetConstructor(
            [
                typeof(string),
    ...
    public override bool Equals(object? obj)
        => ReferenceEquals(this, obj) || (obj is ActianOpenJsonExpression openJsonExpression && Equals(openJsonExpression));

    private bool Equals(ActianOpenJsonExpression other)
    {
